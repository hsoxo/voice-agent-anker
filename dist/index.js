...
var import_realtime_ai_daily = require("@daily-co/realtime-ai-daily");
var import_react_tooltip = require("@radix-ui/react-tooltip");
var import_react10 = __toESM(require("react"));
var import_realtime_ai4 = require("realtime-ai");
var import_realtime_ai_react4 = require("realtime-ai-react");
...
var AppProvider = ({ children }) => {
  const [character, setCharacter] = (0, import_react.useState)(0);
  const [language, setLanguage] = (0, import_react.useState)("en");
  const [clientParams, _setClientParams] = (0, import_react.useState)({
    config: defaultConfig,
    services: defaultServices
  });
  const setClientParams = (0, import_react.useCallback)(
    (newParams) => {
      _setClientParams((p) => ({
...
var import_realtime_ai3 = require("realtime-ai");
var import_realtime_ai_react3 = require("realtime-ai-react");
...
var alertVariants = (0, import_class_variance_authority.cva)("text-left border border-black rounded-lg p-4", {
  variants: {
    intent: {
      info: "alert-info",
...
var Alert = ({ children, intent, title }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: alertVariants({ intent }), children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(AlertTitle, { children: [
      intent === "danger" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react.CircleAlert, { size: 18 }),
      title
    ] }),
    children
  ] });
};
var AlertTitle = import_react2.default.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  "p",
  {
    ref,
    className: cn(
...
var $5e63c961fc1ce211$var$SlotClone = /* @__PURE__ */ (0, import_react4.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  if (/* @__PURE__ */ (0, import_react4.isValidElement)(children)) return /* @__PURE__ */ (0, import_react4.cloneElement)(children, {
...
var import_realtime_ai2 = require("realtime-ai");
var import_realtime_ai_react2 = require("realtime-ai-react");
...
var import_realtime_ai = require("realtime-ai");
var import_realtime_ai_react = require("realtime-ai-react");
...
`;
var pulseText = import_react6.keyframes`
  0%, 100% { opacity: 1; }
  50% { opacity: 0.5; }
`;
var BubbleContainer = import_styled.default.div`
  color: #ffffff;
  position: relative;
  z-index: 20;
  display: flex;
...
`;
var Bubble = import_styled.default.div`
  position: relative;
  cursor: pointer;
  width: 100px;
  height: 100px;
...
`;
var Volume = import_styled.default.div`
  position: absolute;
  overflow: hidden;
  inset: 0px;
  z-index: 0;
...
var AudioIndicatorBubble = () => {
  const volRef = (0, import_react7.useRef)(null);
  (0, import_realtime_ai_react.useRTVIClientEvent)(
    import_realtime_ai.RTVIEvent.LocalAudioLevel,
    (0, import_react7.useCallback)((volume) => {
      if (volRef.current) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Volume, { ref: volRef });
};

// components/Session/ButtonSession.tsx
var import_jsx_runtime5 = require("react/jsx-runtime");
var stats_aggregator;
var ButtonSession = import_react8.default.memo(
  ({ state, onLeave, startAudioOff = false }) => {
    (0, import_realtime_ai_react2.useRTVIClientEvent)(
      import_realtime_ai2.RTVIEvent.Metrics,
      (0, import_react8.useCallback)((metrics) => {
        metrics?.ttfb?.map((m) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "relative w-12 h-12 border rounded-full", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(AudioIndicatorBubble, {}),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Button, { onClick: () => onLeave(), className: "ml-auto z-1000", isRound: true, size: "icon", variant: "ghost", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_lucide_react3.Mic, { size: 16 }) })
    ] });
  },
  (p, n) => p.state === n.state
);
...
function ButtonInner() {
  const voiceClient = (0, import_realtime_ai_react3.useRTVIClient)();
  const transportState = (0, import_realtime_ai_react3.useRTVIClientTransportState)();
  const [appState, setAppState] = (0, import_react9.useState)("idle");
  const [error, setError] = (0, import_react9.useState)(null);
  const [startAudioOff, setStartAudioOff] = (0, import_react9.useState)(false);
  const mountedRef = (0, import_react9.useRef)(false);
  const { clientParams } = (0, import_react9.useContext)(AppContext);
  (0, import_realtime_ai_react3.useRTVIClientEvent)(
    import_realtime_ai3.RTVIEvent.Error,
    (0, import_react9.useCallback)((message) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Button, { onClick: () => start(), disabled: !isReady, isRound: true, size: "icon", children: isReady ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react4.Mic, {}) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react4.Loader2, { className: "animate-spin" }) }, "start") });
}

// components/ButtonApp/index.tsx
var import_jsx_runtime7 = require("react/jsx-runtime");
console.log("React version:", import_react10.default.version);
function ButtonApp({ chatId = "", llmUrl = "", requestTemplate = null }) {
  ...
  const [showSplash, setShowSplash] = (0, import_react10.useState)(true);
  const voiceClientRef = (0, import_react10.useRef)(null);
  (0, import_react10.useEffect)(() => {
    ...
    const llmHelper = new import_realtime_ai4.LLMHelper({});
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_realtime_ai_react4.RTVIClientProvider, { client: voiceClientRef.current, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(AppProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_react_tooltip.TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ButtonInner, {}) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_realtime_ai_react4.RTVIClientAudio, {})
  ] });
}
